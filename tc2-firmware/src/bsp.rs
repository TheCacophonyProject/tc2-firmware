//! A Hardware Abstraction Layer based off the Raspberry Pi Pico,
...
hal::bsp_pins!(
   ...
   Gpio23 {
    ...
    Gpio24 {
     ...
     /// | Function     | Alias with applied function |
     /// |--------------|-----------------------------|
     /// | `SPI1 CS`    | [crate::Gp25Spi1Csn]        |
     /// | `UART1 RX`   | [crate::Gp25Uart1Rx]       |
     /// | `I2C0 SCL`   | [crate::Gp25I2C1Scl]       |
    ...
    Gpio29 {
        ...
        aliases: {
            ...
            FunctionSpi, PullNone: Gp29Spi1Cs,
